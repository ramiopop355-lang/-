...
| الصندوق | الكرات البيضاء | الكرات السوداء | المجموع |
|:-------:|:--------------:|:---------------:|:-------:|
| $U_1$  | ...            | ...             | ...     |
| $U_2$  | ...            | ...             | ...     |
...
**الخطوة 2 — تحديث جدول الحالة بعد كل مرحلة:**
بعد كل سحب محتمل، أعِد حساب محتوى كل صندوق يدوياً وصراحةً:
- مسار (أ): "سُحبت كرة بيضاء من $U_1$" → محتوى الصندوق المستهدف في المرحلة 2 يصبح: [القيم الجديدة الدقيقة].
- مسار (ب): "سُحبت كرة سوداء من $U_1$" → محتوى الصندوق المستهدف يصبح: [القيم الجديدة الدقيقة].

**⚠️ قاعدة حاسمة**: لا تحسب احتمال المرحلة 2 قبل تحديث المحتوى أولاً.

**الخطوة 3 — بناء شجرة الاحتمالات مع التحقق الذاتي:**
...
• **عند كل عقدة**: تحقق أن مجموع الأغصان الخارجة منها = 1 تماماً:
  ...
  - إذا كان المجموع ≠ 1 → خطأ في قراءة المحتوى، أعِد الحساب فوراً قبل المتابعة.

**الخطوة 4 — الاحتمالات المركبة (قاعدة الضرب):**
